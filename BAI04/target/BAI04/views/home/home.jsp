...
<body>
    <div class="container">
        ...
        <a href="${pageContext.request.contextPath}/category/add" class="add-button">Thêm Category mới</a>
            ...
            <tbody>
                <c:forEach var="cat" items="${categories}">
                    <tr>
                        ...
                        <td>
                            <%-- Hiển thị ảnh nếu có, ngược lại hiển thị text --%>
                            <c:if test="${not empty cat.icons}">
                                <img src="${pageContext.request.contextPath}/images/${cat.icons}" alt="Icon" class="icon-image">
                            </c:if>
                            <c:if test="${empty cat.icons}">
                                (Không có ảnh)
                            </c:if>
                        </td>
                         <c:if test="${sessionScope.user.roleid != 2}">
                        ...
                        <td class="actions">
                            <a href="${pageContext.request.contextPath}/category/edit?id=${cat.cateId}">Sửa</a> |
